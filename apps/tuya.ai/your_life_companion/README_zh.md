...
# your_life_companion
 [your_life_companion](https://github.com/tuya/TuyaOpen/tree/master/apps/tuya.ai/your_life_companion) 是基于 tuya.ai 和 T5-AI Board 的智能生活伴侣。在 your_chat_bot 基础上扩展，结合 AI 对话、情绪感知、生活提醒和个性化陪伴，打造一个有温度的桌面智能伙伴。
...
![](../../../docs/images/apps/your_life_companion.png)
