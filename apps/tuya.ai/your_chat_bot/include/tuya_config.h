...
#define TUYA_OPENSDK_UUID    "uuid5bd787406b57186c"             // Please change the correct uuid
#define TUYA_OPENSDK_AUTHKEY "LmVQSdZ8FsXcTXIWjQVma6AjwKghtcOD" // Please change the correct authkey
